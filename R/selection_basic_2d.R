#' @title selection_basic_2d
#'
#' @description This function can be used to sort a 2D population array according to a given selection
...
#' \enumerate{
#'  \item **self$dependents$fitness_function** a function which can evaluate the fitnesses of a 2D population and return a vector of numeric values.
#'  \item **self$dependents$fitness_function_single** a function which can evalue the fitness of a single 1D genotype.
#' }
#'
